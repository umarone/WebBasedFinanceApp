...
namespace MudasirRehmanAlp
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //TopNavbarFiles
            bundles.Add(new ScriptBundle("~/bundles/TopNavbar").Include(
                "~/Scripts/AppJs/TopNavbar.js"
            ));
            ////Selectize Js
            //bundles.Add(new ScriptBundle("~/bundles/SelectizeJs").Include(
            //    "~/Vendor/selectize/js/selectize.js"
            //));
            ////Selectize CSS
            //bundles.Add(new ScriptBundle("~/bundles/SelectizeCSS").Include(
            //    "~/Vendor/selectize/css/selectize.bootstrap4.css"               
            //));
            //Common
            bundles.Add(new ScriptBundle("~/bundles/Common").Include(
                "~/Scripts/AppCommon/Common.js",
                "~/Scripts/AppCommon/AppUtility.js"
            ));
            // Common App Stie Styles
            bundles.Add(new StyleBundle("~/bundles/CommonCss").Include(
                "~/Content/AppCommon/css/CommonAppSite.css"
            ));
            //-------- App Js File 
            //SaleOrderNote
            bundles.Add(new ScriptBundle("~/bundles/SaleOrderNote").Include(
                "~/Scripts/AppJs/SaleOrderNote.js"
            ));
            //-------- App Js File 
            //SaleOrderNote
            bundles.Add(new ScriptBundle("~/bundles/ModalJs").Include(
                "~/Scripts/AppJs/CommonModal.js"
            ));
            bundles.Add(new ScriptBundle("~/bundles/ProductsJs").Include(
              "~/Scripts/AppJs/Products.js"
          ));
            bundles.Add(new ScriptBundle("~/bundles/CommonDashboard").Include(
             "~/Scripts/AppJs/CommonDashboard.js"
         ));
            //Auto Complete
            bundles.Add(new ScriptBundle("~/bundles/autocomplete").Include(
            "~/Scripts/autocomplete/jquery-ui-1.12.1.js",
             "~/Scripts/autocomplete/jquery-ui-1.12.1.min.js",
               "~/Scripts/autocomplete/ui-device.js",
             "~/Scripts/autocomplete/ui-form.js",
             "~/Scripts/autocomplete/ui-load.js",
               "~/Scripts/autocomplete/ui-nav.js",

               "~/Scripts/autocomplete/ui-scroll-to.js",
             "~/Scripts/autocomplete/ui-toggle-class.js"
          ));
            // Demos
            ...
            bundles.Add(new ScriptBundle("~/bundles/toastrJs").Include(
             "~/Scripts/toastrMaster/toastr.js",
             "~/Scripts/toastrMaster/toastr.min.js"
           ));
            ...
            bundles.Add(new StyleBundle("~/bundles/autocompleteCss").Include(
              "~/Content/autocomplet/jquery-ui.css"
            ));

            bundles.Add(new StyleBundle("~/bundles/toastrCss").Include(
             "~/Content/toastrMaster/toastr.css",
             "~/Content/toastrMaster/toastr.min.css"
           ));
        }
    }
}
